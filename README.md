...
Set up and diagnose conversion tracking across all ad platforms with AI agents via MCP.

 `conversion-tracking` `capi` `server-side-tracking` `mcp` `ai-agents`

---

## What is this?

Open this repo in **Amp**, **Cursor**, or **VS Code** and your AI agent can immediately manage Conversion Tracking — no SDK to install, no dependencies. The [Synter MCP server](https://github.com/Synter-Media-AI/mcp-server) is already configured.
...
> Set up a Google Ads conversion action

> Create a GTM conversion tag

> Verify pixel installation on my website

> Diagnose why conversions aren't tracking

> Check for unpublished GTM changes
...
2. Click "Connect" next to Conversion Tracking
